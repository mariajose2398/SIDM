...
obj_cut_defs = {
    ...
    "ljs": {
        ...
        "eLj": lambda objs: objs["ljs"].electron_n > 0 & (objs["ljs"].photon_n == 0),
        "gLj": lambda objs: (objs["ljs"].photon_n > 0 ) & (objs["ljs"].electron_n == 0),
        "eAndGLj": lambda objs: (objs["ljs"].photon_n > 0 ) & (objs["ljs"].electron_n > 0),
        "muLj": lambda objs: objs["ljs"][(objs["ljs"].muon_n >= 2)],
        "dsaMuLj": lambda objs: ((objs["ljs"].muon_n == 2) & (objs["ljs"].dsaMu_n > 0)),
        "pfMuLj": lambda objs: (objs["ljs"].muon_n == 2) & (objs["ljs"].dsaMu_n == 0),
        "2dsaMuLj": lambda objs: (objs["ljs"].muon_n == 2) & (objs["ljs"].dsaMu_n == 2),
        "1dsa1pfMuLj": lambda objs: (objs["ljs"].muon_n == 2) & ((objs["ljs"].dsaMu_n > 0) & (objs["ljs"].pfMu_n > 0)),
    },
    "genMus":{
