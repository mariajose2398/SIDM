...
hist_defs = {
   ...
   "muon_bjet_min_inv_mass": h.Histogram(
    ...
    "mu_lj_vxSpread_dsa": obj_attr("mu_ljs", "vxSpread_dsa", xmax=500, nbins=500),
    "mu_lj_vySpread_dsa": obj_attr("mu_ljs", "vySpread_dsa", xmax=500, nbins=500),
    "mu_lj_vzSpread_dsa": obj_attr("mu_ljs", "vzSpread_dsa", xmax=500, nbins=500),
    "mu_lj_dxySpread_dsa": obj_attr("mu_ljs", "dxySpread_dsa", xmax=500, nbins=500),
    "mu_lj_dzSpread_dsa": obj_attr("mu_ljs", "dzSpread_dsa", xmax=500, nbins=500),
    "mu_lj_vxySpread_dsa": obj_attr("mu_ljs", "vxySpread_dsa", xmax=500, nbins=500),
    ...
    "mu_lj_vySpread_mu": obj_attr("mu_ljs", "vySpread_mu", xmax=500, nbins=500),
    "mu_lj_vzSpread_mu": obj_attr("mu_ljs", "vzSpread_mu", xmax=500, nbins=500),
    "mu_lj_dxySpread_mu": obj_attr("mu_ljs", "dxySpread_mu", xmax=500, nbins=500),
    "mu_lj_dzSpread_mu": obj_attr("mu_ljs", "dzSpread_mu", xmax=500, nbins=500),
    "mu_lj_vxySpread_mu": obj_attr("mu_ljs", "vxySpread_mu", xmax=500, nbins=500),
