...
hist_defs = {
    ...
    "matched_genA_toMu_lxy": h.Histogram(
        [
            h.Axis(hist.axis.Regular(100, 0, 500, name="matched_genA_toMu_lxy"),
                   lambda objs, mask: lxy(derived_objs["matched_genAs_toMu"](objs, 0.4)) ),
        ],
    ),
    "matched_genA_toE_lxy": h.Histogram(
        [
            h.Axis(hist.axis.Regular(100, 0, 500, name="matched_genA_toE_lxy"),
                   lambda objs, mask: lxy(derived_objs["matched_genAs_toE"](objs, 0.4)) ),
        ],
    ),
    "matched_genA_mu_lxy": h.Histogram(
        [
            h.Axis(hist.axis.Regular(100, 0, 500, name="matched_genA__mu_lxy"),
                   lambda objs, mask: lxy(derived_objs["matched_genAs_mu"](objs, 0.4)) ),
        ],
    ),
    "matched_genA_toMu_mu_lxy": h.Histogram(
        [
            h.Axis(hist.axis.Regular(100, 0, 500, name="matched_genA_toMu_mu_lxy"),
                   lambda objs, mask: lxy(derived_objs["matched_genAs_toMu_mu"](objs, 0.4)) ),
        ],
    ),
    "matched_genA_egm_lxy": h.Histogram(
        [
            h.Axis(hist.axis.Regular(100, 0, 500, name="matched_genA__egm_lxy"),
                   lambda objs, mask: lxy(derived_objs["matched_genAs_egm"](objs, 0.4)) ),
        ],
    ),
    "matched_genA_toE_egm_lxy": h.Histogram(
        [
            h.Axis(hist.axis.Regular(100, 0, 500, name="matched_genA_toE_egm_lxy"),
                   lambda objs, mask: lxy(derived_objs["matched_genAs_toE_egm"](objs, 0.4)) ),
        ],
    ),
